...
[![GoDoc](https://godoc.org/ github.com/konglong87/BaiduPCS-Go?status.svg)](https://godoc.org/ github.com/konglong87/BaiduPCS-Go)
...
# 编译/交叉编译 说明
参见 [编译/交叉编译帮助](https:// github.com/konglong87/BaiduPCS-Go/wiki/编译-交叉编译帮助)

# 下载/运行 说明

Go语言程序, 可直接在[发布页](https:// github.com/konglong87/BaiduPCS-Go/releases)下载使用.
...
示例: [Android 运行本项目程序参考示例](https:// github.com/konglong87/BaiduPCS-Go/wiki/Android-运行本项目程序参考示例), 有兴趣的可以参考一下.

苹果iOS, 需要越狱, 在 Cydia 搜索下载并安装 MobileTerminal, 或者其他提供终端环境的软件.

示例: [iOS 运行本项目程序参考示例](https:// github.com/konglong87/BaiduPCS-Go/wiki/iOS-运行本项目程序参考示例), 有兴趣的可以参考一下.
...
[关于 获取百度 BDUSS](https:// github.com/konglong87/BaiduPCS-Go/wiki/关于-获取百度-BDUSS)
...
[关于下载的简单说明](https:// github.com/konglong87/BaiduPCS-Go/wiki/%E5%85%B3%E4%BA%8E%E4%B8%8B%E8%BD%BD%E7%9A%84%E7%AE%80%E5%8D%95%E8%AF%B4%E6%98%8E)
...
参见 [常见问题](https:// github.com/konglong87/BaiduPCS-Go/wiki/%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98)

# TODO


# 相关文档
详见: https:// github.com/konglong87/BaiduPCS-Go/tree/master/docs

# 交流反馈

提交Issue: [Issues](https:// github.com/konglong87/BaiduPCS-Go/issues)
...
|支付宝|微信|
|:-----:|:-----:|
|![alipay](https:// github.com/konglong87/BaiduPCS-Go/raw/master/assets/donate/alipay.jpg)|![weixin](https:// github.com/konglong87/BaiduPCS-Go/raw/master/assets/donate/weixin.png)|
